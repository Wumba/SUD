...
public class Hund {
	...
	public void setGewicht(double gewicht) {
		...
		if (gewicht < 0.5) {
			this.gewicht = 0.5;
			System.out.println(
					"So wenig wiegt kein erwachsener Hund. Der leichteste Hund hiess Miracle Milly und wo ca. 1 Pfund.");
		} else if (gewicht > 143) {
			this.gewicht = 143;
			System.out.println("So schwer ist kein Hund. Der schwerste bekannte Hund hiess Zorbas und wog 143kg.");
		} else {
	...
	/**
	 * Schreibt die Eigenschaften Name, Rasse, Gewicht und Groesse in die Konsole
	 */
	public void ausgabe() {
	...
	//Diese Methode ist nur eine Hilfsmethode und keine Methode, welche Hunde-Funktionalitaet anbietet.
